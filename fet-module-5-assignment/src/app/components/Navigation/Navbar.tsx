...
export default function NavigationBar({ children, sticky, logoStyle = "inline", ...props }:Props) {
    return(
        <>
            <Navbar sticky={sticky || false} {...props}>
                <Link href="/" className={logoStyle === "inline" ? styles.logoInline:styles.logoStacked}>
